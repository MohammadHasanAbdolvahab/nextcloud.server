...
<head>
    ...
    <link rel="stylesheet" href="<?php print_unescaped(OC::$WEBROOT); ?>/themes/mytheme/core/css/design-system.css">
    <link rel="stylesheet" href="<?php print_unescaped(OC::$WEBROOT); ?>/themes/mytheme/core/css/server.css">
    <style>
...
<body>
    <div class="login-wrapper">
        ...
        <div class="brand-section">
            <img src="<?php print_unescaped(OC::$WEBROOT); ?>/themes/mytheme/core/img/logo.svg" alt="<?php p($theme->getTitle()); ?>" class="brand-logo">
